...
public class BrowserWebDriverContainer<SELF extends BrowserWebDriverContainer<SELF>> extends GenericContainer<SELF> implements VncService, LinkableContainer {
    ...
    protected void configure() {
        ...
        /*
         * Some unreliability of the selenium container containers has been observed, so allow multiple attempts to start.
         */
    ...
    /**
     * Obtain a RemoteWebDriver instance that is bound to an instance of the container running inside a new container.
     * <p>
    ...
    public byte[] attachment() throws IOException {
        File file = new File(String.valueOf(currentVncRecordings.stream().findFirst().get().getRecordingPath()));
